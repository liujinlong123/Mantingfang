...
public class ChatLVAdapter extends BaseAdapter {
	...
	public ChatLVAdapter(Context mContext, List<ChatInfo> list, String myHead, String robotHead) {
		super();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			hodler.robotIcon = (CircleImageView)convertView.findViewById(R.id.chatto_icon);
			hodler.myIcon = (CircleImageView)convertView.findViewById(R.id.chatfrom_icon);
	...
	class ViewHodler {
		CircleImageView robotIcon, myIcon;
