...
public class SecondWenkuPoem extends Activity {
	...
	/*
	 * private void getDataFromSQL() { list = new ArrayList<Poem>();
	 * 
	...
	private void getData(final boolean isNetwork, final String labelName) {
		AsyncTask<String, Long, String> task = new AsyncTask<String, Long, String>() {
			...
			protected void onPreExecute() {
				SuccinctProgress.showSuccinctProgress(SecondWenkuPoem.this,
					...
					if (result != null && !result.equals("")) {
						...
						listview.setOnItemClickListener(new OnItemClickListener() {
							...
							public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
								UIHelper.showPoemMDetailTwoById(SecondWenkuPoem.this,
										list.get(position - 1).getPoemId(), 0);
							}
						});
					}
