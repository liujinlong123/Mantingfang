...
public class PictureToPoem {
    ...
    public PictureToPoem(String path) {
    	this.path = path;
    }
    
    public String getJSONArray() throws Exception {
    	String content = Img2Base64Util.GetImageStr(path);
    	String body = "{\"type\": \"1\", \"content\":\"" + content +"\"}";
    	return sendPost(url, body, ak_id1, ak_secret1);
    }
