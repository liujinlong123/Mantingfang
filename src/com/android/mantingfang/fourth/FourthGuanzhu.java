...
public class FourthGuanzhu extends FragmentActivity {
	...
	private Fragment guanzhuL;
	private Fragment guanzhuR;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.fourth_guanzhu);
	...
	private void initViewPager() {
		...
		guanzhuL = new GuanzhuL();
		guanzhuR = new GuanzhuR();
		
		fragmentList.add(guanzhuL);
		fragmentList.add(guanzhuR);
