...
public class ThirdTwoAdapter extends BaseAdapter {
	...
	public ThirdTwoAdapter(Context context, List<UserTwoContent> list, CustomListView listview) {
		this.list = list;
		mContext = context;
	...
	private Handler myHandler = new Handler() {
		...
		public void handleMessage(android.os.Message msg) {
			...
			case REFRESH_DATA_FINISH:
				if (ThirdTwoAdapter.this != null) {
					ThirdTwoAdapter.this.notifyDataSetChanged();
				}
