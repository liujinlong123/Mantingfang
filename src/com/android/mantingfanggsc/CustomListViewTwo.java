 ...
 * 
 */
public class CustomListViewTwo extends ListView implements OnScrollListener {
	...
	public CustomListViewTwo(Context pContext, AttributeSet pAttrs) {
		super(pContext, pAttrs);
		init(pContext);
	}

	public CustomListViewTwo(Context pContext) {
		super(pContext);
		init(pContext);
	}

	public CustomListViewTwo(Context pContext, AttributeSet pAttrs, int pDefStyle) {
