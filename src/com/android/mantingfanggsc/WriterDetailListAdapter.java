	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			case TYPE_ONE:
				...
				holder1.writername.setText("白居易-唐");
				holder1.themename.setText("简介");
				holder1.themedetail.setText("白居易的简介");
				holder1.works.setText("作品/118");
				break;
				
			case TYPE_TWO:
				holder2 = (ViewHolder2)convertView.getTag();
				holder2.poemname.setText("庐山草堂记");
				holder2.kindname.setText("[文]");
				holder2.poemrhesis.setText("匡庐奇秀，甲天下山");
				break;
			}
		}
